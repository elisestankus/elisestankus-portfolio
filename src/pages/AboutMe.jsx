            ...
            <Stack direction={{ xs: 'column-reverse', sm: 'column-reverse', md: 'row' }} spacing={{ xs: 1, sm: 2, md: 4 }}>
                <div>
                    <Typography variant="h6" fontFamily='"Georgia", "Helvetica", "Arial", sans-serif'>
                        Hi there! I'm Elise, a full-stack web developer currently residing in the San Francisco Bay Area. I'm currently seeking opportunities to apply my skills in support of web development teams and projects in a challenging environment conducive to learning and growth.
                    </Typography>
                    <br />
                    <Typography variant="h6" fontFamily='"Georgia", "Helvetica", "Arial", sans-serif'>
